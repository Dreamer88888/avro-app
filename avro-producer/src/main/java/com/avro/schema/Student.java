...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6087137716418781789L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.avro.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\",\"default\":-1},{\"name\":\"name\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"score\",\"type\":\"int\",\"default\":-1}]}");
   ...
   */
  public Student(java.lang.Integer id, java.lang.CharSequence name, java.lang.Integer score) {
    this.id = id;
    this.name = name;
    this.score = score;
  }
   ...
   */
  public static com.avro.schema.Student.Builder newBuilder() {
    return new com.avro.schema.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.avro.schema.Student.Builder newBuilder(com.avro.schema.Student.Builder other) {
    return new com.avro.schema.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.avro.schema.Student.Builder newBuilder(com.avro.schema.Student other) {
    return new com.avro.schema.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.avro.schema.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.avro.schema.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.schema.Student.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.schema.Student.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.schema.Student.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.schema.Student.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.schema.Student.Builder setScore(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.schema.Student.Builder clearScore() {
